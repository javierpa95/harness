...
- **"Quiero que vaya solo, sin preguntas"** → `make mode MODE=auto`: bash queda permitido salvo comandos destructivos (`rm -rf`, force-push...). Vuelve a supervision con `MODE=seguro`. Tecla m en el dashboard.
